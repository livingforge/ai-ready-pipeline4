...
pub fn bundled() -> [Asset<'static>; 4] {
    [
        Asset {
            path: ".claude/skills/arp4/SKILL.md",
            body: include_bytes!(concat!(env!("OUT_DIR"), "/claude-arp4.md")),
        },
        Asset {
            path: ".claude/skills/arp4-setup/SKILL.md",
            body: include_bytes!(concat!(env!("OUT_DIR"), "/claude-arp4-setup.md")),
        },
        Asset {
            path: ".github/skills/arp4/SKILL.md",
            body: include_bytes!(concat!(env!("OUT_DIR"), "/github-arp4.md")),
        },
        Asset {
            path: ".github/skills/arp4-setup/SKILL.md",
            body: include_bytes!(concat!(env!("OUT_DIR"), "/github-arp4-setup.md")),
        },
    ]
}
...
pub fn install_assets(root: &Path, assets: &[Asset<'_>]) -> Result<usize> {
    ...
    let root = root.canonicalize().context("project root must exist")?;
    if !root.is_dir() {
